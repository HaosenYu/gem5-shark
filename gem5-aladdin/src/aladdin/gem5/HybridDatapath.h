...
class HybridDatapath : public ScratchpadDatapath, public Gem5Datapath {
 ...
 public:
  ...
  //TODO delayed flag send attack simulation only
  void delayedFinishSignal();
 ...
 protected:
  ...
  // Delayed Retry Event for cache retries. TODO for attack simulation only
  EventWrapper<HybridDatapath, &HybridDatapath::delayedFinishSignal> delayedFinishSignalEvent;
  PacketPtr delayedFinishPkt;
