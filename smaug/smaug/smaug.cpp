...
int main(int argc, char* argv[]) {
    ...
    //useSystolicArrayWhenAvailable = true; //use systolic TODO
    ...
    options.add_options()
        ...
        ("use-systolic-array",
         ...
         ("enable-swap-att",
            po::value(&enable_swap_att)->implicit_value(true),
            "Enabling swap attack. Randomly swapping the index of pixels.");
    // clang-format on
